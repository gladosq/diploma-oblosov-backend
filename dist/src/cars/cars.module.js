...
exports.CarsModule = CarsModule = __decorate([
    (0, common_1.Module)({
        imports: [
            typeorm_2.TypeOrmModule.forFeature([typeorm_1.EducationModule]),
            typeorm_2.TypeOrmModule.forFeature([typeorm_1.Users])
        ],
        providers: [cars_service_1.CarsService, authentication_service_1.AuthenticationService],
